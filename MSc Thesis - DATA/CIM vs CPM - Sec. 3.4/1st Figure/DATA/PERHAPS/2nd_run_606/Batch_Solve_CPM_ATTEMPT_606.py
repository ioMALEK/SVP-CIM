...
#  • sparsity = std/mean of 50-vector pool   → logged & printed
#  • Q after every BRI:  Q = min(max(1, floor(sparsity)), 20)
#  • λQ baseline: exact enum if Q≤4, Monte-Carlo otherwise
#  • Optuna budgets scale with Q²   (Nt, Ne, Me)
#  • B_avg (mean norm of reduced basis) logged & printed
#  • γ-cap block schedule now falls back to last block (no StopIteration)
# ======================================================================
